...
<body>
    ...
    <!-- Form -> Form Control cari Read only plain text -> password -->
    <div class="container">
        <form method="POST" action="proses2.php" enctype="multipart/form-data">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input required type="text" name="nama_siswa" class="form-control" id="nama"
                        placeholder="Ex: Alexander" value=<?php echo $nama_siswa; ?>>
                </div>
            </div>
            <div class="mb-3 row">
                <label for="jkel" class="col-sm-2 col-form-label">NISN</label>
                <div class="col-sm-10">
                    <!-- Form -> Select Default-->
            ...
            <!-- Form -> Form control -> Example textarea -->
            <!-- <div class="mb-3">
